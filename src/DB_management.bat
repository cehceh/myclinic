...
start cmd.exe /k "D: && activate clinicenv && echo activating.. && cd D:\Django\projects\myclinic\src\ && python clinic\manage.py makemigrations --settings=clinic.settings.development"
echo activating and enter the target folder.. && ^
echo makemigrations_db .. ^

start cmd.exe /k "D: && activate clinicenv && echo activating.. && cd D:\Django\projects\myclinic\src\ && python clinic\manage.py migrate --settings=clinic.settings.development && ^
