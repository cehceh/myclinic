...
def edit_lab_visit(request, lab_id, patient_id, visit_id):
    ...
    if form.is_valid():
        ...
        lab_form.patient_id = patient_id
        lab_form.save()
        messages.success(request, 'Saving changes to prescription done ...')
